...
echo -e "\n##### 11 - Log to the cluster with kubectl#####\n"
az aks get-credentials --resource-group $ACR_RESOURCE_GROUP --name $AKS_CLUSTER_NAME
echo -e "\n##### 12 - verify the connection to your cluster with kubectl#####\n"
kubectl get nodes
echo -e "\n##### 13 - update the manifeste file#####\n"
...
echo -e "\n##### 15 - Wait until the application starts #####\n"
